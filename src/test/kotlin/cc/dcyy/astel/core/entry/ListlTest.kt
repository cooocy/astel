...
class ListlTest {
    ...
    @Test
    fun testNew() {
        val l1 = Listl.Companion.new()
        assertEquals(0, l1.size())

        val l2 = Listl.Companion.new(10, ChronoUnit.MICROS, 1, 2, 3, "Four")
        assertEquals(4, l2.size())
    }

    @Test
    fun testGet() {
        val l = Listl.Companion.new(1, 2, 3, "Four")
    ...
    @Test
    fun testRange() {
        val l1 = Listl.Companion.new(1, 2, 3, "Four", "Five", "Six", "Seven")
